...
- [Hệ Thống Tưới Tự Động Sử Dụng ESP8266 NodeMCU và Blynk](#hệ-thống-tưới-tự-động-sử-dụng-esp8266-nodemcu-và-blynk)
  ...
  * [7. Chức năng các đoạn mã](#7-chức-năng-các-đoạn-mã)
    ...
    + [7.10. `BLYNK_WRITE(VPIN_MODE_SELECT)`](#710-blynk_write-vpin_mode_select)
    + [7.11. `BLYNK_WRITE(VPIN_HUMIDITY_THRESHOLD_HIGH)` và `BLYNK_WRITE(VPIN_HUMIDITY_THRESHOLD_LOW)`](#711-blynk_write-vpin_humidity_threshold_high-và-blynk_write-vpin_humidity_threshold_low)
    + [7.12. `BLYNK_WRITE(VPIN_RELAY_CONTROL)`](#712-blynk_write-vpin_relay_control)
    + [7.13. `BLYNK_WRITE(VPIN_TIME_INPUT)`](#713-blynk_write-vpin_time_input)
